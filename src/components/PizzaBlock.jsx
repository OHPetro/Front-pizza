...
const PizzaBlock = ({ id, imageUrl, price, title, types }) => {
  ...
  if (addedPizza) {
    Object.keys(addedPizza).map((type) => (numberOfPizza += addedPizza[type].count));
  }
      ...
      <div className="pizza-block">
        ...
        <div className="pizza-block__price-and-button">
          ...
          <button className="pizza-block__button" onClick={addToCart}>
            ...
            <div className="pizza-block__button-counter">
              <span>{numberOfPizza}</span>
            </div>
          </button>
        </div>
      </div>
